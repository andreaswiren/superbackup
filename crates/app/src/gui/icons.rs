    ...
    fn draw(self, d: &mut Draw<'_>) {
        match self {
            ...
            Icon::HardDrive => {
                ...
                d.path(&[(5.45, 5.11), (2.0, 12.0), (2.0, 18.0), (22.0, 18.0), (22.0, 12.0), (18.55, 5.11)]);
            ...
            Icon::FolderOpen => {
                d.path(&[(3.0, 19.5), (3.0, 5.0), (4.0, 4.0), (9.0, 4.0), (11.0, 6.5), (19.0, 6.5), (20.0, 7.5), (20.0, 10.0)]);
                d.path(&[(3.0, 19.5), (6.2, 11.0), (22.5, 11.0), (19.3, 19.5), (3.0, 19.5)]);
            }
            Icon::FileText => {
                d.path(&[(14.0, 2.5), (5.5, 2.5), (4.5, 3.5), (4.5, 20.5), (5.5, 21.5), (18.5, 21.5), (19.5, 20.5), (19.5, 8.0), (14.0, 2.5)]);
                d.path(&[(14.0, 2.5), (14.0, 8.0), (19.5, 8.0)]);
                d.line(8.0, 13.0, 16.0, 13.0);
                d.line(8.0, 17.0, 16.0, 17.0);
            }
            Icon::FilterX => {
                d.path(&[(21.0, 3.0), (3.0, 3.0), (10.0, 11.5), (10.0, 20.0), (14.0, 18.0), (14.0, 11.5), (17.0, 8.0)]);
            ...
            Icon::Stethoscope => {
                d.path(&[(4.5, 3.0), (4.5, 8.0), (7.5, 12.0), (11.5, 12.0), (14.5, 8.0), (14.5, 3.0)]);
                d.path(&[(9.5, 12.0), (9.5, 15.5), (13.5, 18.5), (17.5, 16.5)]);
                d.circle(19.0, 14.0, 2.6);
            }
            Icon::Sparkles => {
                d.closed(&[(9.0, 3.0), (10.6, 7.4), (15.0, 9.0), (10.6, 10.6), (9.0, 15.0), (7.4, 10.6), (3.0, 9.0), (7.4, 7.4)]);
                d.closed(&[(18.0, 13.0), (18.9, 15.1), (21.0, 16.0), (18.9, 16.9), (18.0, 19.0), (17.1, 16.9), (15.0, 16.0), (17.1, 15.1)]);
            }
            Icon::Shield => {
                d.closed(&[(12.0, 2.5), (20.0, 5.5), (20.0, 11.5), (12.0, 21.5), (4.0, 11.5), (4.0, 5.5)]);
            }
            Icon::Play => {
            ...
            Icon::PlugZap => {
                ...
                d.path(&[(4.5, 6.0), (17.5, 6.0), (17.5, 10.0), (15.0, 13.5), (7.0, 13.5), (4.5, 10.0), (4.5, 6.0)]);
            ...
            Icon::Pencil => {
                d.path(&[(16.5, 3.5), (20.5, 7.5), (8.0, 20.0), (3.0, 21.0), (4.0, 16.0), (16.5, 3.5)]);
            ...
            Icon::Printer => {
                ...
                d.path(&[(7.0, 17.5), (4.0, 17.5), (3.0, 16.5), (3.0, 10.0), (4.0, 9.0), (20.0, 9.0), (21.0, 10.0), (21.0, 16.5), (20.0, 17.5), (17.0, 17.5)]);
...
mod tests {
    ...
    fn success_and_failure_have_different_silhouettes() {
        ...
        assert_ne!(
            Icon::for_status(RunStatus::Succeeded),
            Icon::for_status(RunStatus::Failed)
        );
        assert_eq!(Icon::for_status(RunStatus::Failed), Icon::XOctagon);
        assert_eq!(
            Icon::for_status(RunStatus::SucceededWithWarnings),
            Icon::AlertTriangle
        );
    }
