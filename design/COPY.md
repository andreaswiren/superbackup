...
preview.title                 = "Preview of {job}"
preview.tooltip               = "See what this job would copy, without copying anything"
preview.nothing_written       = "Nothing was written. This was a rehearsal."
preview.nothing_written.body  = "No file was copied, no snapshot was created and nothing was deleted at any destination. The figures below are what a real run would have produced."
preview.running               = "Working out what would be copied..."
preview.started               = "Working out what \"{job}\" would copy. Nothing is being written."
preview.empty                 = "Run a preview and the result appears here, one card per destination."
preview.per_destination       = "One card per destination. superbackup never adds these together: a job that reached two destinations out of three has not backed up."
preview.files                 = "Files"
preview.total_size            = "Total size"
preview.would_copy            = "Would be copied"
preview.unchanged             = "Already up to date"
preview.unknown_split         = "kopia estimates the whole source and does not say how much of it is already stored, so the new-versus-unchanged split is not available for a repository."
preview.no_paths              = "Individual paths are not available"
preview.no_paths.repo         = "`kopia snapshot estimate` reports totals only; it does not list the files it counted."
preview.no_paths.mirror       = "The mirror rehearsal counts every file as it walks the tree but does not keep the list, so there is nothing to show."
preview.not_rehearsable       = "This destination could not be rehearsed"
preview.and_more              = "and {count} more"
preview.rerun                 = "Preview again"
preview.run_for_real          = "Back up now"
...
machines.setting              = "Leave a note next to the backups saying which computer wrote them"
machines.setting.body         = "Writes a small `_superbackup` folder at each destination holding this computer's label, host name, operating system and the date it last backed up, plus a plain-text README. It is what makes a shared drive readable during a recovery. It contains no file names and no keys."
machines.setting.s3           = "Object storage cannot hold it. A bucket has no folder superbackup can write to outside the repository kopia manages, so S3 and StorJ destinations get no note."
machines.title                = "Computers backing up here"
machines.empty                = "No computer has left a record at this destination yet."
machines.unsupported          = "Not recorded for object storage."
machines.this_pc              = "This computer"
machines.last_seen            = "Last backed up {when}"
machines.refresh              = "Look again"
machines.unreadable           = "That location could not be read from this window."
```
...
keys.check                    = "Check this key"
keys.check.stored             = "Check the stored key"
keys.checking                 = "Opening the repository..."
keys.check.ok                 = "The repository opened with this key."
keys.check.bad                = "The repository did not accept this key."
keys.check.none               = "There is no repository here yet, so there is nothing to check the key against."
keys.check.note               = "This is not a format check. superbackup opens the repository with the key and tells you what happened."

keys.export.title             = "Back up your encryption keys"
keys.export.lead              = "A repository encryption key that is lost cannot be recovered by anyone, including us. Write these somewhere safe."
keys.export.warn.title        = "This file is worth as much as the backups"
keys.export.warn.body         = "It is not encrypted. Anyone holding it can read your backups. A password manager, a safe, or paper - not Downloads, and not email."
keys.export.confirm           = "Enter your master passphrase to continue"
keys.export.save              = "Choose a file and save"
keys.export.copy              = "Copy as text instead"
keys.export.copied            = "Copied. Your clipboard now holds your encryption keys."
keys.export.cancelled         = "Nothing was saved."
keys.export.omitted           = "Not included"
keys.export.empty             = "There are no repository encryption keys to export yet. Create a repository first."
keys.export.preview           = "What the file will contain"
keys.export.not_shown         = "The keys are not shown here on purpose. They go straight into the file you choose, so they never appear on your screen."
keys.export.saved             = "Encryption keys written to {path}. Move it somewhere safe now."
...
kopia.where.title             = "Which kopia is being used"
kopia.where.lead              = "superbackup does not do the backing up itself. Kopia does, and this is the exact copy of it being run."
kopia.path                    = "Full path"
kopia.version                 = "Version"
kopia.provenance              = "Found by"
kopia.banner                  = "Reports itself as"
kopia.minimum                 = "Minimum accepted"
kopia.reveal                  = "Show in folder"
kopia.reveal.failed           = "This system could not open a file browser at that folder."
kopia.not_found               = "No usable kopia was found"
kopia.not_found.body          = "Until one is available, repository destinations cannot be created, connected to, or backed up. Folder mirrors still work."
kopia.routes.title            = "Where superbackup looked"
kopia.routes.lead             = "In this order. The first one that produces a working kopia new enough to drive is the one used."
kopia.route.chosen            = "In use"
kopia.verify.title            = "Check it for yourself"
kopia.verify.lead             = "This runs kopia now and shows you everything it printed. Nothing is written and no backup is started."
kopia.verify.button           = "Run the checks"
kopia.verify.against          = "Check a repository as well"
kopia.verify.against.none     = "Version only"
kopia.verify.empty            = "Nothing has been run yet. Press the button and the exact command, its exit code and its output appear here."
kopia.command_line            = "Command"
kopia.command_line.note       = "Safe to show and safe to paste into a terminal: encryption keys and storage keys are passed to kopia through environment variables, never on the command line."
kopia.secret_env              = "Secrets passed in"
kopia.exit_code               = "Exit code"
kopia.stdout                  = "Output"
kopia.stderr                  = "Errors"
kopia.no_output               = "(nothing printed)"
kopia.not_attempted           = "Not run"
kopia.managed.title           = "The build superbackup manages"
kopia.managed.lead            = "When no kopia is installed, superbackup downloads one from Kopia's own releases and checks it against the SHA-256 published with it."
kopia.managed.path            = "Kept at"
kopia.managed.version         = "Installed version"
kopia.managed.none            = "Not installed"
kopia.update.policy           = "When a newer kopia is released"
kopia.update.off              = "Do nothing"
kopia.update.notify           = "Tell me, and let me decide"
kopia.update.automatic        = "Install it"
kopia.update.check            = "Check for an update now"
kopia.update.none             = "No update check has been made in this window yet."
kopia.update.available        = "kopia {version} is available."
kopia.prefer_system           = "Prefer a kopia already installed on this computer"
```
